...
console.log(1 < 2 < 3);
console.log(3 > 2>1);// false çünkü soldan sağa dooğru işlem gerçekleşecek 3>2 'den bunun sonucu true olarak çıkacak sonra true>1 den olacak bu da 1>1 den gibi olduğundan cevap false
...
console.log(isNaN(2 + null));// isnan func bir ifadenin isnan olup olmadığının kontrol eder.
